...
;(function ($, window, document, undefined) {
	...
	var defaults = {
		...
		'bounceMarker'               : true,
		'catMarkers'                 : null,
		'dataLocation'               : 'map/data/locations.json',
		'dataRaw'                    : null,
		'dataType'                   : 'json',
		'debug'                      : false,
		'defaultLat'                 : null,
    ...
    "stylers": [
      {
		...
		// Templates
		'infowindowTemplatePath'     : 'map/js/plugins/storeLocator/templates/infowindow-description.html',
		'listTemplatePath'           : 'map/js/plugins/storeLocator/templates/location-list-description.html',
		'KMLinfowindowTemplatePath'  : 'map/js/plugins/storeLocator/templates/kml-infowindow-description.html',
		'KMLlistTemplatePath'        : 'map/js/plugins/storeLocator/templates/kml-location-list-description.html',
		'listTemplateID'             : null,
		...
		createMarker: function (point, name, address, letter, map, category) {
			...
			if (this.settings.callbackCreateMarker) {
				...
				if (this.settings.disableAlphaMarkers === true || this.settings.storeLimit === -1 || this.settings.storeLimit > 26 || this.settings.catMarkers !== null || this.settings.markerImg !== null || (this.settings.fullMapStart === true && firstRun === true && (isNaN(this.settings.fullMapStartListLimit) || this.settings.fullMapStartListLimit > 26 || this.settings.fullMapStartListLimit === -1))) {
					...
					letterMarkerImg = {
						url: 'https://mt.googleapis.com/vt/icon/name=icons/spotlight/spotlight-waypoint-a.png&text=' + letter + '&psize=16&font=fonts/Roboto-Regular.ttf&color=ff333333&ax=44&ay=48'
					};
